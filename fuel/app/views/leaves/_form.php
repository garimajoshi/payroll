...
<div class="grid-8-12">
    ...
    <div class="grid-6-12">
                            <div class="grid-4-12 ">
        <?php echo Form::submit('submit', 'Save', array("style" => "margin-top:25px;","class"=>"btn")); ?>
    </div>
        <div class="grid-4-12">
<?php echo Form::submit('new','Add Another Leave',array("style" => "margin-top:25px;", "class"=>"btn")); ?>
        </div>
    </div>
    <?php echo Form::close(); ?>