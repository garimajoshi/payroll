...
<div class="grid-12-12">
    ...
    <div class="grid-9-12" style="font-size: 18px">
        <table>
            <tbody>
                <tr>
                    <td><input type="checkbox" name="dol_date[]" value="1" /> 1</td>
                    <td><input type="checkbox" name="dol_date[]" value="2" /> 2</td>
                    <td><input type="checkbox" name="dol_date[]" value="3" /> 3</td>
                    <td><input type="checkbox" name="dol_date[]" value="4" /> 4</td>
                    <td><input type="checkbox" name="dol_date[]" value="5" /> 5</td>
                    <td><input type="checkbox" name="dol_date[]" value="6" /> 6</td>
                    <td><input type="checkbox" name="dol_date[]" value="7" /> 7</td>
                    <td><input type="checkbox" name="dol_date[]" value="8" /> 8</td>
                    <td><input type="checkbox" name="dol_date[]" value="9" /> 9</td>
